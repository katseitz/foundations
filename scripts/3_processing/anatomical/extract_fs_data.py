...
fs_dir = ('/projects/b1108/studies/foundations/data/preprocessed/neuroimaging/freesurfer_23_2') #or use below for same data
...
def main():
    ...
    all_subs_df.to_csv("foundations_t1_sMRI_09062024.csv")
