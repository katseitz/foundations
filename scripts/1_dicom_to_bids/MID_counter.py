...
def main():
    dirs = glob.glob("/projects/b1108/studies/foundations/data/raw/neuroimaging/bids/sub-f*/ses-1/func/*tsv") 
    df = pd.DataFrame()
    ...
    df.to_csv("HARP_Foundations_MID_trial_types_counts_akash_test.csv")
